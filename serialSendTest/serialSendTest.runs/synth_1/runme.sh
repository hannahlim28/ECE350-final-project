...
HD_PWD='C:/Users/rm519/Documents/serialSendTest/serialSendTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sending_tx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sending_tx.tcl
