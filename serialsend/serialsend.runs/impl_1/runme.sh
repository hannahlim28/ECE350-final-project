...
HD_PWD='C:/Users/rm519/Documents/serialSendTest/serialSendTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sending_tx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sending_tx.tcl -notrace
