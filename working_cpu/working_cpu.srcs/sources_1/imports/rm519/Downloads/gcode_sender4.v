module gcode_sender(
    ...
    reg [7:0] x1_ascii [3:0];
    reg [7:0] y1_ascii [3:0];
    reg [7:0] x2_ascii [3:0];
    reg [7:0] y2_ascii [3:0];
...
//    localparam BUFFER_TM = 0.002;
    localparam NUM_CYCLES = 12500000;
            ...
            case(state)
                ...
                SENDG1: begin
                    ...
                    if(see_ready && index != 25)begin
                        ...
                        if(buffer_counter == (NUM_CYCLES - 1))begin
                            buffer_counter <= 0;
                            index <= 0;
                            state <= SENDG2;
                        end else begin
